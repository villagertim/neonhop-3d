...
class NeonHopGatewayHandler(http.server.SimpleHTTPRequestHandler):
    ...
    PUBLIC_FILES = frozenset({
        ...
        *(f"/src/{name}.js" for name in (
            ...
            "leaderboard", "jevAgent", "jevOnlyAgent", "physicsOracle", "learningBrain", "jevEvaluator"
        ))
    })
