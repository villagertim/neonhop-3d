// src/jevEvaluator.js
// TypeSafe Jev (typesafe/jev-1.13) System One Fast Decision Engine & Local Primitive Evaluator
// Provides sub-millisecond local calibrated evaluations for training benchmarks
// and connects to OpenRouter /api/jev/decision proxy for cloud inference.
...
export class JevEvaluator {
    ...
    // High-speed local calibrated evaluation adhering strictly to Jev's RLCD probability primitives
